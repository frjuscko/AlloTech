...
$stmt = $pdo->query($sql);
$techs_aleatoires = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Récupérer 3 compétences aléatoires
$sql = "SELECT * FROM competences ORDER BY RAND() LIMIT 3";
$stmt = $pdo->query($sql);
$competences_aleatoires = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Récupérer 3 villes aléatoires
                ...
                <div class="bar">
                    ...
                    <div class="btns">
                        ...
                        <div class="user">
                            ...
                            <div class="names">
                                <p class="body gris_texte bold"><?= htmlspecialchars($auth['prenom']) ?> <?= htmlspecialchars($auth['nom']) ?></p>
                        ...
                        <div class="stat card" id="techs">
                            <div class="left">
                                <svg
                                    ...
                                    17.4549L16.5305 16.9775L18 14L19.4695 16.9775L22.7553 17.4549L20.3776 19.7725L20.9389 
                                    23.0451L18 21.5ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 
                                    10.315 15.315 13 12 13Z"></path></svg>
                                <p
                                    class="stat_name body gris_texte">Techniciens</p>
                                <h1 class="gris_texte"><?= count($techs) ?></h1>
                            </div>
                            <div class="right">
                                <div class="elements">
                                    <?php foreach($techs_aleatoires as $tech): ?>
                                        <div class="photo_container element">
                                            <img src="<?= htmlspecialchars($tech['photo']) ?>" alt="<?= htmlspecialchars($tech['id']) ?>">
                                        </div>
                                    <?php endforeach ?>    
                                </div>
                            </div>
                        </div>
                        <div class="stat card" id="skills">
                            <div class="left">
                                ...
                                <p
                                    class="stat_name body gris_texte">Compétences</p>
                                <h1 class="gris_texte"><?= count($competences) ?></h1>
                            </div>
                            <div class="right">
                                <div class="elements">
                                    <?php foreach($competences_aleatoires as $skill): ?>
                                        <div class="photo_container element">
                                            <img src="<?= htmlspecialchars($skill['photo']) ?>" alt="<?= htmlspecialchars($skill['id']) ?>">
                                        </div>
                                    <?php endforeach ?>  
                                </div>
                            </div>
                        </div>
                        <div class="stat card" id="cities">
                            <div class="left">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"><path
                                        d="M21 19H23V21H1V19H3V4C3 3.44772 3.44772 3 4 3H14C14.5523 3 15 3.44772 15 4V19H17V9H20C20.5523 9 21 9.44772 21 10V19ZM7 11V13H11V11H7ZM7 7V9H11V7H7Z"></path></svg>
                                <p class="stat_name body gris_texte">Villes</p>
                                <h1 class="gris_texte"><?= count($villes) ?></h1>
                            </div>
                            <div class="right">
                                <div class="elements">
                                    <?php foreach($villes_aleatoires as $ville): ?>
                                        <div class="photo_container element">
                                            <img src="<?= htmlspecialchars($ville['photo']) ?>" alt="<?= htmlspecialchars($ville['id']) ?>">
                                        </div>
                                    <?php endforeach ?> 
                                </div>
                            </div>

        ...
        <main>
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><a href="skills.html" class="btn_link fluide"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" fill="currentColor"><path
                    ...
                    <li><a href="villes.html" class="btn_link fluide index"><svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" fill="currentColor"><path
                ...
                <div class="interface">
                    ...
                    <div class="container">
                        <div class="form_box">
                            ...
                            <div class="form_body">
                                <form action="traitements/addVille.php" method="post" enctype="multipart/form-data">
